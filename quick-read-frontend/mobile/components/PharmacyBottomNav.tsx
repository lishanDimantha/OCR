...
export default function PharmacyBottomNav() {
  ...
  return (
    <BlurView intensity={40} tint="light" style={styles.bottomNav}>
      <TouchableOpacity style={styles.navItem} onPress={() => router.replace('/pharmacy-home')}>
      ...
      <TouchableOpacity
        style={styles.navItem}
        onPress={() => router.push('/pharmacy-notification')}
      >
        {pathname === '/pharmacy-notification' ? (
          <View style={styles.activeIconWrapper}>
      ...
      <TouchableOpacity
        style={styles.navItem}
        onPress={() => router.push('/pharmacy-settings')}
      >
        {pathname === '/pharmacy-settings' ? (
          <View style={styles.activeIconWrapper}>
